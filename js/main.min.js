...
videoItem.forEach(function(videoItem) {
...
//     if ($(window).width() < 780) {
//             $('#carousel-top').addClass("owl-carousel");
//             $('#carousel-top').owlCarousel({
//                 nav: true,
//                 loop:true,         
//                 items: 1,
...
//             });
//             function callBack(){
//                 if($('#carousel-top .owl-item').last().hasClass('active')){
//                       $('.owl-next').hide();
//                       $('.owl-prev').show(); 
//                       console.log('true');
...
//         }else{
//             $('#carousel-top').owlCarousel('destroy');
//             $('#carousel-top').removeClass("owl-carousel");
//         }
//     }
